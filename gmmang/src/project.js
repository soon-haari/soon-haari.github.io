    ...
    var a = e("./GameManager"),
      ...
      p = function (e) {
        ...
        return o(t, e), n = t, t.prototype.onLoad = function () {
          ...
          1 != e && (this.bencichengji.getComponent(cc.Sprite).spriteFrame = this.bencichengjiarr[e - 1], this.gengduoyouxi.getComponent(cc.Sprite).spriteFrame = this.gengduoyouxiarr[e - 1]), this.continueTip.getComponent(cc.Label).string = 1 == e ? "\u70b9\u51fb\u7ee7\u7eed" : 2 == e ? "\u9ede\u64ca\u7e7c\u7e8c" : 4 == e ? "\ud074\ub9ad \ud558\uc5ec \uacc4\uc18d" : "Click Continue", this.adsButton2 && (this.adsButton2.active = !1, this.adsButton2.stopAllActions(), this.adsButton2.off(cc.Node.EventType.TOUCH_START), this.adsButton2.off(cc.Node.EventType.TOUCH_END), this.adsButton2.getComponent(cc.Button) && (this.adsButton2.getComponent(cc.Button).enabled = !1)), this.reStartBtn.runAction(cc.repeatForever(cc.sequence(cc.scaleTo(.5, 1.1), cc.scaleTo(.55, 1), cc.delayTime(.5)))), cc.tween(this.moreGameBtn).to(.5, {
            scale: 1.1
          }).to(.5, {
            scale: 1
    ...
    var a = e("../common/PlayerInfo"),
      ...
      h = function (e) {
        ...
        return o(t, e), n = t, t.prototype.onLoad = function () {
          ...
          var e = this;
          this.ShowScorePanel(), s.default.Instance.GetLevel() % 5 == 1 ? (this.passlevelYQ = .12, this.lerpCtrl = !0) : s.default.Instance.GetLevel() % 5 == 2 ? (this.passlevelYQ = .31, this.lerpCtrl = !0) : s.default.Instance.GetLevel() % 5 == 3 ? (this.passlevelYQ = .51, this.lerpCtrl = !0) : s.default.Instance.GetLevel() % 5 == 4 ? (this.passlevelYQ = .71, this.lerpCtrl = !0) : s.default.Instance.GetLevel() % 5 == 0 && (this.passlevelYQ = 1, this.lerpCtrl = !0), this.adsButton && (this.adsButton.active = !1), this.adsButton && this.adsButton.active && cc.tween(this.adsButton).call(function () {
  ...
  gameOverJs: [function (e, t, n) {
    ...
    cc.Class({
      ...
      UIPosChange: function () {
        ...
        if (this.overInfoT.node.height = Math.ceil(e.length * this.overInfoT.fontSize / this.overInfoT.node.width) * t, document.title = "금망게임", console.log("gameOver txtMoreText", a.txtMoreText), this.midGameText.string = a.txtMoreText, this.leftBtnText.string = a.txtAgainText, this.tempArr = this.gameFocus(), null != a.ranLinkUrl()) {
          var n = a.ranLinkUrl(),
